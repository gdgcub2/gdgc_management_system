...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-semibold text-gray-900">Member Dashboard</h1>
          ...
          <div className="flex items-center space-x-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-white/80 text-sm">• Joined {userProfile.joinDate}</span>
              </div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-5xl font-bold mb-2">{userProfile.totalPoints}</div>
            <div className="text-white/80">Total Points</div>
          </div>
        </div>
        <div className="mt-6 bg-white/10 backdrop-blur-sm rounded-xl p-4">
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm">Progress to {userProfile.nextLevel}</span>
            <span className="text-sm">{userProfile.pointsToNext} points needed</span>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Event History</h3>
        ...
        <motion.div
          ...
          className="bg-white rounded-2xl p-6 border border-gray-200 shadow-sm"
        >
          <h3 className="text-lg font-semibold text-gray-900 mb-6">Recommended Events</h3>
          <div className="space-y-3">
