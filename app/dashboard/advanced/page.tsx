    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Leaderboards, badges, and notifications
        </p>
      </div>
      ...
      >
              ...
              <div className="flex items-center space-x-4 flex-1">
                ...
                <div className="flex-1">
                  <div className="flex items-center space-x-2">
                    ...
                    {user.rank <= 3 && (
                      <Medal className="w-4 h-4 text-[#FBBC05]" />
                    )}
                  </div>
        ...
        <div className="mt-6 p-4 bg-gradient-to-br from-blue-50 to-green-50 rounded-xl border border-gray-200">
          <div className="flex items-center justify-between mb-2">
            <div className="font-medium text-gray-900">Your Rank</div>
            <div className="text-2xl font-bold text-[#4285F4]">#6</div>
          </div>
          <div className="text-sm text-gray-600 mb-2">
            You need 70 more points to reach rank #5
          </div>
      ...
      >
        <div className="flex items-center space-x-3 mb-6">
          ...
          <h3 className="text-xl font-semibold text-gray-900">Badge System</h3>
        </div>
          ...
          {Object.entries(emailPreferences).map(([key, value], index) => (
            ...
            >
              ...
              <Switch.Root
                checked={value}
                onCheckedChange={() =>
                  togglePreference(key as keyof typeof emailPreferences)
                }
        ...
        <div className="mt-6 p-6 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex items-start space-x-3 p-3 bg-white rounded-lg border border-gray-200">
              <Bell className="w-5 h-5 text-[#4285F4] mt-0.5" />
              <div className="flex-1">
            ...
            <div className="flex items-start space-x-3 p-3 bg-white rounded-lg border border-gray-200">
              <Star className="w-5 h-5 text-[#FBBC05] mt-0.5" />
              <div className="flex-1">
                <div className="font-medium text-gray-900 text-sm">
