  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#4285F4]/10 via-[#FBBC05]/10 to-[#34A853]/10 flex items-center justify-center p-6">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#EA4335]/20 rounded-full blur-3xl" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-[#FBBC05]/20 rounded-full blur-3xl" />
      </div>
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              Create your GDGC Management account
            </p>
          </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                >
                  ...
                  <div className="text-xs text-gray-600 mt-1">Attend events</div>
                </button>
                ...
                >
                  <div className="text-2xl mb-1">📅</div>
                  <div className="text-xs font-medium text-gray-900">Event Manager</div>
                  <div className="text-xs text-gray-600 mt-1">Manage events</div>
                </button>
